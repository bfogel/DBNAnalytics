...
function dbnScoringCalculator_Create() {
    ...
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringFunctions.js?x=1'></script>";
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringCalculator.js?x=1'></script>";
