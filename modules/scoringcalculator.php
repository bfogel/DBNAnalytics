...
function dbnScoringCalculator_Create() {
    ...
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringFunctions.js?x=4'></script>";
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringCalculator.js?x=4'></script>";
