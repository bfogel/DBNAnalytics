...
function dbnScoringCalculator_Create() {
    ...
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringFunctions.js?x=7'></script>";
    $ret .= "<script src = '/wp-content/plugins/DBNAnalytics/js/ScoringCalculator.js?x=7'></script>";
